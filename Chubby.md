# CHUBBY/PAXOS - DISTRIBUTED LOCKING CONCEPTS 
...
Locks - Each chubby node can act as a reader-writer lock in one of the following two ways:
...
Sequencer - With distributed systems, receiving messages out of order is a problem; Chubby uses sequence numbers to solve this problem. After acquiring a lock on a file, a client can immediately request a ‘Sequencer,’ which is an opaque byte string describing the state of the lock:
...
![image](https://user-images.githubusercontent.com/13011167/133950194-5c12baa6-c4d6-450a-9b2d-2790d82de525.png)

Lock-delay - For file servers that do not support sequencers, Chubby provides a lock-delay period to protect against message delays and server restarts.
